...
> Project status: early development. The CLI skeleton is available; the first
> usable release is planned as v0.1.0.
...
These commands are the v0.1.0 target and will be delivered incrementally. See
the repository issues for current implementation status.
